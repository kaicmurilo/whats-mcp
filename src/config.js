...
const baseWebhookURL = process.env.BASE_WEBHOOK_URL || 'http://localhost:3000'
...
const recoverSessions = (process.env.RECOVER_SESSIONS || 'true').toLowerCase() === 'true'
...
// Auth desabilitado no MCP standalone
